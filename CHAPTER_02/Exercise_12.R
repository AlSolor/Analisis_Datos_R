...
library("modeest")
library("moments")
# The company con only hire people with a responsability score above 52 points.
#How many subjects would be hired?
...
subject_below_52 <- subset(subjects,Var1 == '52')$t3
